...
const documentReady = () => {
  ...
  const headerNavLinkList = document.querySelector('.header-nav__menu-link-list');
  ...
  const openMenu = () => {
    headerNavLinkList.classList.add('header-nav__menu-link-list--open');
  };

  const closeMenu = () => {
    headerNavLinkList.classList.remove('header-nav__menu-link-list--open');
  };
          ...
          <div className="header-nav__theme-menu-container">
            ...
            <ul className="header-nav__menu-link-list">
              <li className="header-nav__menu-link-item">
                <NavLink to="/cupcakes" className="header-nav__menu-link">Cupcakes</NavLink>
              </li>
              <li className="header-nav__menu-link-item">
                <NavLink to="/nosotros" className="header-nav__menu-link">Nosotros</NavLink>
              </li>
              <li className="header-nav__menu-link-item">
                <a href="https://www.linkedin.com/in/elliotgaramendi/" className="header-nav__menu-link header-nav__menu-link--active" target="_blank" rel="noreferrer">Elliot</a>
              </li>
